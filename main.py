...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        self.embed.set_footer(text="Loco Answer | ༄Pk᭄✿BROTHER࿐8035™ ||")
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NzQyODE1NTM4MjUzNzkxMjYy.XzLm4Q.CkIVBKhdAX1bbs02eKu2GZPbSUE'))
    loop.run_forever()
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('NzAyNDk4MTc1OTM1ODQwMzE2.XqQvjw.VY9cwAvxn-9dgy8MtEM8PfebLwU',NjM2MDM4MjIyMTA3MTE1NTIw.XzLbCg.lNz2CMYB4JS1_WPu-4OzwS_rWPI
                                   bot=False))
    loop.run_forever()
